...
export default function Home() {
  ...
  if (!isLoaded) {
    return (
      <div className="flex items-center justify-center h-screen bg-[#0a0b14] text-white">
        <div className="flex flex-col items-center gap-6">
          <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl flex items-center justify-center text-3xl animate-pulse shadow-2xl shadow-indigo-500/20">
            🚀
          </div>
          <div className="flex flex-col items-center">
            <span className="text-sm font-bold tracking-[0.2em] uppercase text-indigo-400">Initializing</span>
            <span className="text-xs text-slate-500 mt-1">Liquid Automata Engine</span>
          </div>
        </div>
      </div>
    );
